...
fetch("https://tsioftas.github.io/tsioftolithomata/jsondata/pages.json").then((resp) => resp.json()).then((json) => {
    pages = json["pages"];
...
fetch('https://tsioftas.github.io/tsioftolithomata/templates/header.html')
